...
replace(variables('CuerpoLimpio'), '\n', '<br>')
...

{
  ...
  "body": [
    ...
    },
    {
      ...
      "wrap": true,
      "fontType": "Monospace",
      "text": "@{trim(replace(replace(split(split(variables('TextoPlano'),'DETALLES TÉCNICOS:')[1],'DETALLES ADICIONALES:')[0],'\\n','\n'),'\\r',''))}"
    },
    {
      "type": "TextBlock",
    ...
    },
    {
      ...
      "wrap": true,
      "fontType": "Monospace",
      "text": "@{trim(replace(replace(split(split(variables('TextoPlano'),'DETALLES ADICIONALES:')[1],'Puede ver')[0],'\\n','\n'),'\\r',''))}"
    }
  ]
}
