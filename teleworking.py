...
class TeletrabajoApp:
    ...
    def render_resumen(self):
        ...
        self.crear_tarjeta_resumen(stats_row, f"Mes actual ({hoy.strftime('%Y-%m')})", resumen_mes).pack(side="left", fill="both", expand=True, padx=(0, 6))
        self.crear_tarjeta_resumen(stats_row, f"Trimestre actual (T{trimestre} {hoy.year})", resumen_trim).pack(side="left", fill="both", expand=True, padx=(6, 0))
    ...
    def crear_tarjeta_resumen(self, parent, titulo, resumen):
        ...
        filas = [
            ...
            ("Asuntos propios", resumen["asuntos_propios"]),
    ...
    def render_calendario(self):
        ...
        ttk.Button(controls, text="← Mes anterior", command=self.mes_anterior, style="Primary.TButton").pack(side="left")
        ttk.Button(controls, text="Mes siguiente →", command=self.mes_siguiente, style="Primary.TButton").pack(side="left", padx=8)
